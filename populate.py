...
Original file is located at
    https://colab.research.google.com/drive/1WRCz3-LVLL_jDpMPt5h9S2S_HM_gYAmD
"""
...
conn = psycopg2.connect(host = "localhost" , dbname = "netflix" , user = "vivek" , password = "123456" , port = 5432)
cur = conn.cursor()

data_mov = pd.read_csv('movies.csv')
data_mov.head()

data_gen = pd.read_csv("genre.csv")
data_gen.head()
...
data_act = pd.read_csv('actors.csv')
data_act
...
data_dir = pd.read_csv('director.csv')
data_dir
